...
return new class extends Migration
{
    ...
    {
        Schema::create('sub_o_contents', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('o_content_id'); // ความสัมพันธ์กับตาราง o_contents
    ...
    {
        Schema::dropIfExists('sub_o_contents');
    }
};
